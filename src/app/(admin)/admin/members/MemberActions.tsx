    ...
    <>
      <div className="inline-flex items-center gap-1.5">
        ...
        <button
          ...
          className="rounded-lg border border-red-200 bg-white px-2.5 py-1.5 text-xs font-medium text-red-600 transition-colors hover:bg-red-50 disabled:opacity-50"
          title={isCurrentUser ? "Tidak dapat menghapus akun sendiri" : "Hapus anggota"}
        >
          Hapus
        </button>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-elevated">
            ...
            <p className="mt-2 text-sm text-neutral-600">
              Apakah Anda yakin ingin menghapus <strong>{memberName}</strong>?
